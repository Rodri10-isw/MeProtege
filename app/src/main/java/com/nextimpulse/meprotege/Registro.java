...
public class Registro extends AppCompatActivity {
    ...
    private Button btn1,btndat,btnFoto,btnComp,btnine,btnext;
    //variables a guardar
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eDir=(EditText)findViewById(R.id.edtDir);
        eNoC=(EditText)findViewById(R.id.edtNoC);
        eNoT=(EditText)findViewById(R.id.edtNoT);
        btn1=(Button)findViewById(R.id.btnReg);
        btndat=(Button)findViewById(R.id.btnDate);
        btnFoto=(Button)findViewById(R.id.btnFotoP);
        btnComp=(Button)findViewById(R.id.btnCom);
        btnine=(Button)findViewById(R.id.btnINE);
        btnext=(Button)findViewById(R.id.btnExt);
        tvFotoP=(ImageView)findViewById(R.id.tvFotoP);
            ...
            public void onClick(View view) {
                        ...
                        !noTel.isEmpty())
                {
                    if (contra.length() > 6){
                        ...
                        Toast.makeText(Registro.this, "La contraseña debe de tener minimo 6 digitos",Toast.LENGTH_SHORT).show();
                    }
                    ...
                    mDatabase.child("Users").child(id).setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task2) {
                            if (task2.isSuccessful()){
                                ...
                                Toast.makeText(Registro.this, "No se pudo crear al usuario",Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
    ...
    public static int funcional(int alt){
        ...
        alt=1+num.nextInt(500);
        n2=1+num.nextInt(500);
    ...
    public void tomarFoto(){
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            try {
                ...
                Toast.makeText(Registro.this, "Error mientras se crear el archivo", Toast.LENGTH_SHORT).show();
            }
            if (photoFile !=null){
